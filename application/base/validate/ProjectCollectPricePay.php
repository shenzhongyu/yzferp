...
class ProjectCollectPricePay extends Validate
{
    protected $rule = [
        ...
        ['desc','require', '申请原因不能为空'],
    ];
    protected $scene = [
        'add'    => ['collect_type','collect_name','collect_price','collect_date','invoice_value','invoice_price'],
        'price'=>['payment_id','bank_id','collect_price'],

        'refund'=>['collect_type','collect_name','collect_price','collect_date','invoice_value','invoice_price','desc'],
    ];
