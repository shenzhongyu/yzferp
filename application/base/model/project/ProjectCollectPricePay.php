...
class ProjectCollectPricePay extends Base
{

    protected $table = "mk_project_collect_price_pay";
    ...
    public function payCollectPrice($data,$guid){
        ...
        if($obj["examine_status"]!=1){
            return self::showReturnCodeWithOutData(1003,'该款项未通过审核，无法付款');
        }
        $price=$obj['collect_price'];
        if ($data['collect_price']>$obj['price']){
            return self::showReturnCodeWithOutData(1003,'付款资金不合法');
        }
        ...
        try{
            ...
            $save_data = [
                ...
                "desc" =>$obj['project_name'].'项目的'.'的'.$obj['collect_name'].'支出',
                "type" =>3, //材料款
