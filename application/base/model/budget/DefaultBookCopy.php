...
class DefaultBookCopy extends Base
{

    protected $table = "mk_budget_default_book_copy";
    ...
    public function getBook($guid,$book_number){
        $list=$this->getList(["project_id"=>$guid,'book_number'=>$book_number]);
        $arr=[];
        if (!empty($list)){
